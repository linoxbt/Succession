...
| P4 frontend loading | Verified locally | Browser wallet and listing components were removed. The production app bundle is 17.58 kB minified (5.78 kB gzip), separate from the landing bundle. |
